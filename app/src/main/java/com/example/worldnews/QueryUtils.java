...
public class QueryUtils {
    ...
    private static List<News> extractFromJson(String newsJSON) {
        ...
        try {
            ...
            // Create a JSONObject from the baseJSON response
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                String date = currentResult.getString("webPublicationDate").substring(0, 10);
                String author = "";
                ...
                News news = new News(title, section, date, author, webUrl);
                newsList.add(news);
            }
